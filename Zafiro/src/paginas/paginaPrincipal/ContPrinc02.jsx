    ...
    return (
      <>
        <Container fluid className="contenedor02">
          <Row className="contentColumna02">
            <Col className="filaUno02" sm={6}>
              <Image
                src={fondoImg}
                alt="Fondo Principal 02"
                className="imagenPrinc02"
              ></Image>
            </Col>
            <Col className="info02" sm={6}>
              <h2>Transforma tu Futuro con un Intercambio Universitario</h2>
